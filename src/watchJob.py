...
def get_remote_file_by_id(ssh, directory, file_id):
    ...
    matches = [f for f in files if str(file_id) in f]#match any file with the jobid in the name
...
slurm_log_dir = "~/Scrollpolitik/hpc"#dir in which the .out file will end up
